...
placesArr.add(new Country(280, 280, Color.YELLOW, "Marvin Avenue",new Coordinates(500,50)));
placesArr.add(new SpecialPlaces("Jail" ,new Coordinates(570,90)));

placesArr.add(new Country(300, 300, Color.GREEN, "PACIFIC AVENUE", new Coordinates(570, 50)));
placesArr.add(new Country(300, 300, Color.GREEN, "NORTH CAROLINA AVENUE", new Coordinates(570, 90)));
placesArr.add(new SpecialPlaces("COMMUNITY CHEST", new Coordinates(570, 140)));
placesArr.add(new Country(320, 320, Color.GREEN, "PENNSYLVANIA AVENUE", new Coordinates(570, 190)));
placesArr.add(new SpecialPlaces("SHORT LINE", new Coordinates(570, 240)));
placesArr.add(new SpecialPlaces("CHANCE", new Coordinates(570, 290)));
placesArr.add(new Country(350, 350, Color.BLUE, "PARK PLACE", new Coordinates(570, 340)));
placesArr.add(new SpecialPlaces("LUXURY TAX", new Coordinates(570, 390)));
placesArr.add(new Country(400, 400, Color.BLUE, "BOARDWALK", new Coordinates(570, 440)));
